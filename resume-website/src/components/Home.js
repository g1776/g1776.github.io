          ...
          <Grid container>
            <Grid item xs={12} lg={8}>
              ...
              <section className={classes.intro}>
                ...
                which has gotten me to the national level of concert bands and an opportunity to play at Carnegie Hall! I also enjoy listening to and playing jazz. I am minoring in Jazz Performance.
                </Typography>
                <Typography variant="h6" className={classes.introParagraph}>
