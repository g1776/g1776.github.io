...
const projectsList = [
	...
	>
		<p>
			This was my Capstone Project for my Applied Data Science major at Penn State, with
			<ProjectLink to="https://ist.psu.edu/directory/juy1">Dr. John Yen</ProjectLink> as an
			advisor throughout the 5 month long project. The project was done in partnership with
			the Penn State Smeal College of Business, which has a relationship with Airbnb. This is
			how we got the data and inspiration to do the project.
		</p>
		<p>
			The goal of the proejct was to create a machine learning model that can classify Airbnb
		...
		<p>
			To do this, we had to do a large amount of data exploration and feature engineering, to
			best understand how to teach a model what it means for a listing to be misleading. This
			included a variety of Natural Language Processing (NLP) techniques, as well as
			dimensionality reduction techniques, namely:
		</p>
		<ul>
			<li>Principal Component Analysis (PCA)</li>
			<li>t-SNE</li>
			<li>BERT pretrained sentiment model</li>
			<li>Text Embeddings with Word2Vec</li>
			<li>N-grams</li>
			<li>Keyword search</li>
		</ul>
		<p>
			After feature engineering, we trained and evaluated several baseline machine learning
			models, with a K Nearest Neighbors Classifier being the top performer, with a test
			accuracy of 93%. We also evaluated how the model would perform on a transfer learning
			task. finally, we built a Streamlit app which allowed us to visualize the results of
			the mode which you can find a screenshot of in the paper. You can read the paper by
	...
	>
		<p>
			KCF Technologies is a company that has a machine health platform for monitoring
